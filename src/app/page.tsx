...
export default function Home() {
  return (
    <div className="bg-white h-screen py-6 sm:py-8 lg:py-12">
      <div className="h-full mx-auto max-w-screen-2xl px-4 md:px-8">
        <div className="mb-4 flex items-center justify-between gap-8 sm:mb-8 md:mb-12">
          <div className="flex items-center gap-12">
            <h2 className="text-3xl font-bold text-gray-800 lg:text-3x">Antonio Martínez</h2>

            <p className="hidden max-w-screen-sm text-gray-500 md:block">
            Fullstack Developer with experience in simple. mobile and enterprise solutions.
            </p>
          </div>
        ...
        <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 md:gap-6 xl:gap-8">
          ...
          <a href="#" className="group relative flex h-48 items-end overflow-hidden rounded-lg bg-gray-100 shadow-lg md:h-80">
            ...
            <span className="relative ml-4 mb-3 inline-block text-sm text-white md:ml-5 md:text-lg">About me</span>
          </a>
          ...
          <a href="#" className="group relative flex h-48 items-end overflow-hidden rounded-lg bg-gray-100 shadow-lg md:col-span-2 md:h-80">
            ...
            <span className="relative ml-4 mb-3 inline-block text-sm text-white md:ml-5 md:text-lg">Projects</span>
          </a>
          ...
          <a href="#" className="group relative flex h-48 items-end overflow-hidden rounded-lg bg-gray-100 shadow-lg md:col-span-2 md:h-80">
            ...
            <span className="relative ml-4 mb-3 inline-block text-sm text-white md:ml-5 md:text-lg">Dev code snippets</span>
          </a>
          ...
          <a href="#" className="group relative flex h-48 items-end overflow-hidden rounded-lg bg-gray-100 shadow-lg md:h-80">
            ...
            <span className="relative ml-4 mb-3 inline-block text-sm text-white md:ml-5 md:text-lg">Social Networks</span>
          </a>
